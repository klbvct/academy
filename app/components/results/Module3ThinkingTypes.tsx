  ...
  return (
    <section className="mb-10" style={{ pageBreakInside: 'avoid' }}>
      ...
      <div style={{ background: '#f8f9fa', padding: '20px', borderRadius: '8px', marginBottom: '25px' }}>
        <p style={{ marginBottom: '10px', lineHeight: '1.6', fontSize: '14px' }}>Людське мислення багатогранне: у різних ситуаціях ми використовуємо різні способи аналізу, уявлення та прийняття рішень. Проте серед них завжди є ті, які проявляються частіше за інші та визначають спосіб сприйняття інформації, прийняття рішень і навчання.</p>
        <p style={{ marginBottom: '10px', lineHeight: '1.6', fontSize: '14px' }}>У цьому розділі відображені <strong style={{ color: '#1e3a8a' }}>домінуючі типи мислення</strong> — ті, що найбільше впливають на ваш стиль мислення та можуть підказати напрямки, у яких вам буде легше розвиватися та реалізовувати свій потенціал.</p>
      </div>
