  ...
  return (
    <section className="mb-10" style={{ pageBreakInside: 'avoid' }}>
      ...
      <div style={{ background: '#f8f9fa', padding: '20px', borderRadius: '8px', marginBottom: '25px' }}>
        <p style={{ marginBottom: '10px', lineHeight: '1.6', fontSize: '14px' }}>У цьому розділі визначаються ваші <strong style={{ color: '#1e3a8a' }}>домінуючі канали сприйняття та обробки інформації</strong>. Люди по-різному сприймають навколишній світ: хтось краще запам’ятовує інформацію через зображення, інші — через звук, рух або логічний аналіз.</p>
        <p style={{ marginBottom: '10px', lineHeight: '1.6', fontSize: '14px' }}>Розуміння власного способу сприйняття допомагає визначити найбільш ефективний стиль навчання, засвоєння нових знань та взаємодії з інформацією.</p> 
        <p style={{ marginBottom: '10px', lineHeight: '1.6', fontSize: '14px' }}>Результати показують, <strong style={{ color: '#1e3a8a' }}>які канали сприйняття є для вас найбільш природними та ефективними</strong>, що може допомогти обрати оптимальні методи навчання та роботи з інформацією.</p>
      </div>
