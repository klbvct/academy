  ...
  return (
    <section className="mb-10" style={{ pageBreakInside: 'avoid' }}>
      ...
      <p style={{ marginTop: '20px', lineHeight: '1.6', fontSize: '13px' }}>
        Напрямки та сфери, в яких ви набрали від 70% до 100%, є найбільш вираженими у вашій освітній карті. Саме в цих галузях закладений найбільший потенціал для розвитку, адже вони найкраще відповідають вашим інтересам, здібностям і внутрішній мотивації.
        Сфери, які набрали від 50% до 70%, також мають значний потенціал для вас. Ймовірно, у вас уже є інтерес до них, а необхідні навички в цих напрямках можуть доволі легко розвиватися з часом. Такі галузі можна розглядати як альтернативні варіанти навчання або як напрями, що доповнюватимуть основну спеціалізацію.
        Якщо показник знаходиться в межах 20–30%, це свідчить про низький рівень інтересу до цих сфер. Вони не є природним фокусом вашої уваги, тому розвиток у цих напрямках може вимагати більше зусиль і мотивації.
        Результат від 0% до 20% означає, що ці галузі наразі майже не викликають у вас інтересу. Ймовірно, у вас немає внутрішньої мотивації або бажання глибше занурюватися в їх вивчення та дослідження.
      </p>
    </section>
  );
}
