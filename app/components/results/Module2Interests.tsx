  ...
  return (
    <section className="mb-10" style={{ pageBreakInside: 'avoid' }}>
      ...
      <p style={{ marginTop: '20px', lineHeight: '1.6', fontSize: '13px' }}>
        Напрямки та сфери, в яких ви набрали від <strong>70% до 100%</strong>, є найбільш вираженими у вашій освітній карті. Саме в цих галузях закладений <strong>найбільший потенціал для розвитку</strong>, адже вони найкраще відповідають вашим інтересам, здібностям і внутрішній мотивації.<br />
        Сфери, які набрали <strong>від 50% до 70%</strong>, також мають значний потенціал для вас. Ймовірно, у вас уже є інтерес до них, а необхідні навички в цих напрямках можуть <strong>доволі легко розвиватися з часом</strong>. Такі галузі можна розглядати як <strong>альтернативні варіанти навчання</strong> або як напрями, що <strong>доповнюватимуть основну спеціалізацію</strong>.<br />
        Якщо показник знаходиться в межах <strong>20%–30%</strong>, це свідчить про <strong>низький рівень інтересу</strong> до цих сфер. Вони не є природним фокусом вашої уваги, тому розвиток у цих напрямках може вимагати більше зусиль і мотивації.<br />
        Результат <strong>від 0% до 20%</strong> означає, що ці галузі наразі <strong>майже не викликають у вас інтересу</strong>. Ймовірно, у вас немає внутрішньої мотивації або бажання глибше занурюватися в їх вивчення та дослідження.
      </p>
    </section>
  );
}
