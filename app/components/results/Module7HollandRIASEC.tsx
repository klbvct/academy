    ...
    <section className="mb-10" style={{ pageBreakInside: 'avoid' }}>
      ...
      <div style={{ background: '#f8f9fa', padding: '20px', borderRadius: '8px', marginBottom: '25px' }}>
        <p style={{ marginBottom: '12px', lineHeight: '1.6', fontSize: '13px' }}>
          У цьому розділі визначається ваш профіль професійних інтересів відповідно до теорії американського психолога Джона Голланда, відомої як модель RIASEC. Вона описує шість основних типів особистості та професійних інтересів, кожен з яких відображає схильність людини до певного стилю діяльності, способу мислення та робочого середовища.
          За результатами тесту формується ваш <strong style={{ color: '#1e3a8a' }}>професійний код</strong>, який складається з <strong style={{ color: '#1e3a8a' }}>трьох типів, що проявилися найсильніше</strong>. Саме ця комбінація допомагає зрозуміти, у яких професійних сферах ви можете почуватися найбільш природно, реалізовувати свої здібності та бути ефективним в роботі.
