                  ...
                  {test.isCompleted && (
                    <>
                      ...
                      <button
                        ...
                        disabled={loadingResults === test.id}
                        className="w-full mt-auto rounded-lg py-2 transition font-semibold text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-70 flex items-center justify-center gap-2"
                      >
                        {loadingResults === test.id ? (
                          <>
                            <svg className="animate-spin h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
