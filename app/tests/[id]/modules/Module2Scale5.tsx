...
export function Module2Scale5({ questions, answers, onAnswerChange, scale }: Module2Scale5Props) {
  return (
          ...
          <div className="ml-6">
            <div className="flex gap-2 flex-wrap">
              {scale?.map((scaleValue) => (
                <label key={scaleValue} className="cursor-pointer">
                  <span
                    ...
                    style={{
                      borderColor:
                        answers[`q${question.number}`] === scaleValue
                          ? '#0c68f5'
                          : '#e5e7eb',
                      color:
                        answers[`q${question.number}`] === scaleValue
                  ...
                  >
                    <input
                      ...
                      value={scaleValue}
                      checked={answers[`q${question.number}`] === scaleValue}
